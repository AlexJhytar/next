...
const BlockClients = ({getBlock, pageLoaded}) => {
	...
	const lang = useLocale();
	 ...
	 return (
			<div className={`clients ${!pageLoaded ? "loading" : ''}`}
					 onMouseEnter={() => pause()}
					 onMouseLeave={() => play()}
			>

				 {
						pageLoaded ? <Swiper{...params} onSwiper={setSwiperRef}>
...
export default memo(BlockClients);